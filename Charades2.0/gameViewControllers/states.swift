...
class statesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func newWord(shuffling: [String]) {
        if states.count > countTimesTapped {
    ...
    func shuffleArray() -> [String] {
        ...
        for _ in 1...states.count {
            ...
            shuffledStates.append(states[randomNumber])
            states.remove(at: randomNumber)
            upperLimit -= 1
        }
    ...
    @IBAction func startGameButton(_ sender: Any) {
            ...
            
        {
            ...
            let audioPath = Bundle.main.path(forResource: "US", ofType: "mp3")
